...
public class AddSupplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnPDF, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 730, -1, -1));
        ...
        getContentPane().add(btnExcel, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 730, -1, -1));
        ...
        getContentPane().add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 730, -1, -1));
        ...
        jScrollPane3.setViewportView(jTable1getData);
        if (jTable1getData.getColumnModel().getColumnCount() > 0) {
            jTable1getData.getColumnModel().getColumn(0).setHeaderValue("Sl No.");
            jTable1getData.getColumnModel().getColumn(1).setHeaderValue("Supplier Name");
            jTable1getData.getColumnModel().getColumn(2).setHeaderValue("Supplier Type");
            jTable1getData.getColumnModel().getColumn(3).setHeaderValue("Address");
            jTable1getData.getColumnModel().getColumn(4).setHeaderValue("Mobile Number");
            jTable1getData.getColumnModel().getColumn(5).setHeaderValue("Other");
            jTable1getData.getColumnModel().getColumn(6).setHeaderValue("GST Type");
            jTable1getData.getColumnModel().getColumn(7).setHeaderValue("GST Number");
            jTable1getData.getColumnModel().getColumn(8).setHeaderValue("Tin No.");
            jTable1getData.getColumnModel().getColumn(9).setHeaderValue("Bank Account No.");
            jTable1getData.getColumnModel().getColumn(10).setHeaderValue("IFSC");
        }

        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 80, 870, 580));
        ...
        getContentPane().add(EditAndUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 680, -1, -1));
        ...
        getContentPane().add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 680, -1, -1));
        ...
        getContentPane().add(txtSupplierNameSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 680, 140, -1));
        ...
        getContentPane().add(btnSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(1220, 680, -1, -1));

        jLabel17.setText("Supplier Name");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 680, 90, 20));

        jLabel19.setText("Total Supplier");
        getContentPane().add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 680, 80, 20));
        ...
        getContentPane().add(txtTotalSupplier, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 680, 160, -1));
...
// Get the selected row index
        ...
        int supplierPrimaryKey = (int) jTable1getData.getValueAt(selectedRowIndex, 0);
    ...
    private void txtTotalSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtTotalSupplierActionPerformed
        int rowCount = jTable1getData.getRowCount();
...
// Add a new method to perform the search and update the table
 ...
 try {
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            String pdfFilePath = pdfFile.getAbsolutePath() + ".pdf";

            PdfWriter.getInstance(document, new FileOutputStream(pdfFilePath));
            document.open();

            // Add a title to the PDF
            document.add(new Paragraph("Supplier Data"));

            // Create a PDF table
            com.itextpdf.text.pdf.PdfPTable pdfTable = new com.itextpdf.text.pdf.PdfPTable(13); // Number of columns
        
            // Add table headers
            pdfTable.addCell("Supplier Name");
            pdfTable.addCell("Supplier Type");
            pdfTable.addCell("Address");
            pdfTable.addCell("Mobile");
            pdfTable.addCell("Alternate Mobile");
            pdfTable.addCell("Email");
            pdfTable.addCell("Other Details");
            pdfTable.addCell("Consumer Type");
            pdfTable.addCell("GST Type");
            pdfTable.addCell("GST Number");
            pdfTable.addCell("TIN Number");
            pdfTable.addCell("Bank Number");
            pdfTable.addCell("IFSC Number");

            // Get data from the supplier table in your database and populate the PDF table
            Connection con = ConnectionProvider.getCon();
            ...
            while (rs.next()) {
                pdfTable.addCell(rs.getString("supplierName"));
                pdfTable.addCell(rs.getString("supplierType"));
                pdfTable.addCell(rs.getString("address"));
                pdfTable.addCell(rs.getString("mobileNumber"));
                pdfTable.addCell(rs.getString("altMobile"));
                pdfTable.addCell(rs.getString("email"));
                pdfTable.addCell(rs.getString("otherDetails"));
                pdfTable.addCell(rs.getString("conType"));
                pdfTable.addCell(rs.getString("gstType"));
                pdfTable.addCell(rs.getString("gstNumber"));
                pdfTable.addCell(rs.getString("tinNumber"));
                pdfTable.addCell(rs.getString("bankAccountNo"));
                pdfTable.addCell(rs.getString("ifsc"));
            }
    ...
    Sheet sheet = workbook.createSheet("Supplier Data");

    // Create a header row
    Row headerRow = sheet.createRow(0);
    String[] headers = {"Supplier Name", "Supplier Type", "Address", "Mobile", "Alternate Mobile", "Email", "Other Details", "Consumer Type", "GST Type", "GST Number", "TIN Number", "Bank Number", "IFSC Number"};
    ...
    try {
        // Get data from the database and populate the Excel sheet
        Connection con = ConnectionProvider.getCon();
        String sql = "SELECT * FROM supplier";
        PreparedStatement ps = con.prepareStatement(sql);
        ResultSet rs = ps.executeQuery();
        ...
        while (rs.next()) {
            ...
            dataRow.createCell(0).setCellValue(rs.getString("supplierName"));
            dataRow.createCell(1).setCellValue(rs.getString("supplierType"));
            dataRow.createCell(2).setCellValue(rs.getString("address"));
            dataRow.createCell(3).setCellValue(rs.getString("mobileNumber"));
            dataRow.createCell(4).setCellValue(rs.getString("altMobile"));
            dataRow.createCell(5).setCellValue(rs.getString("email"));
            dataRow.createCell(6).setCellValue(rs.getString("otherDetails"));
            dataRow.createCell(7).setCellValue(rs.getString("conType"));
            dataRow.createCell(8).setCellValue(rs.getString("gstType"));
            dataRow.createCell(9).setCellValue(rs.getString("gstNumber"));
            dataRow.createCell(10).setCellValue(rs.getString("tinNumber"));
            dataRow.createCell(11).setCellValue(rs.getString("bankAccountNo"));
            dataRow.createCell(12).setCellValue(rs.getString("ifsc"));
        }
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            String excelFilePath = fileChooser.getSelectedFile().getAbsolutePath() + ".xlsx";
            FileOutputStream outputStream = new FileOutputStream(excelFilePath);
            workbook.write(outputStream);
            outputStream.close();
            JOptionPane.showMessageDialog(this, "Supplier data exported to Excel successfully.");
        }
        ...
        ex.printStackTrace();
        JOptionPane.showMessageDialog(this, "Error exporting supplier data to Excel: " + ex.getMessage());
    }
